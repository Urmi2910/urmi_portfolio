...
export function Footer({ aboveBottomNav = false }: { aboveBottomNav?: boolean }) {
  ...
  return (
    <footer
      id="contact"
      className={cn(
        "mt-auto scroll-mt-20 border-t border-border/20 bg-surface safe-bottom",
        aboveBottomNav && "case-study-footer-offset"
      )}
    >
      <div className={cn("container-page", aboveBottomNav ? "py-4 sm:py-5" : "py-6 sm:py-7")}>
